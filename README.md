# OSS-Fuzz-Gen (AGF Fork — Claude Sonnet 4.6 + Reproducibility)
...
1. **Claude Sonnet 4.6 support** via the direct Anthropic API (no Vertex AI
   ...
   `ANTHROPIC_API_KEY`.
2. **A reproducibility package** at [`agf_experiment/`](agf_experiment/).
...
The fork is intended for academic reproducibility of the AGF benchmark.
...
```bash
git clone https://github.com/OwenSanzas/oss-fuzz-gen.git
cd oss-fuzz-gen

python3 -m venv .venv && source .venv/bin/activate
pip install -r requirements.txt
pip install -r agf_experiment/requirements.txt
...
[`agf_experiment/README.md`](agf_experiment/README.md).
